...
import { useGaPageView } from '../events/gaPageView/gaPageView.js'
  ...
  return (
    <>
      ...
      <Script
        ...
        const isProductionWebsite = window.location.href.includes('${appConfig.siteInfo
          ?.domain}') || window.location.href.includes('${appConfig.siteInfo.domain}')
