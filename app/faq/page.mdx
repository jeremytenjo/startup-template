...
Simply visit the <Link href={navLinks.access.signUp.url}>Sign Up</Link> page and click “Get Started” or “Sign Up.” Follow the steps to create your account and begin using our services.
